...
- [x] Реализация WebRTC P2P (обмен SDP/ICE через SignalR)
- [x] Передача MIDI-событий через DataChannel
- [x] Синхронизация состояния синтезаторов между клиентами

###  Этап 3: Визуализация и UX
- [x] 3D-сцена на Three.js (сферы участников, лучи нот)
- [ ] Синхронизация анимаций с общим BPM
- [x] Виртуальные ручки (Knobs) для управления фильтрами
